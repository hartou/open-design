...
export const uk: Dict = {
  ...
  'settings.welcomeTitle': 'Налаштування ArrowFlow Design',
  ...
  'settings.agentInstall.pathHint':
    'Якщо ви встановили CLI через npm або Homebrew, але вона все ще відображається як не встановлена, переконайтеся, що bin-каталог інструмента є у PATH, який успадковує daemon ArrowFlow Design (у macOS PATH у Terminal і GUI-застосунків може відрізнятися). Див. QUICKSTART.md (розділ "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Відкрийте Встановити або Документація для потрібного агента.',
  'settings.agentInstall.stepAuth':
    'Пройдіть автентифікацію у CLI постачальника (увійдіть або додайте API-облікові дані), потім поверніться до ArrowFlow Design.',
  ...
  'settings.mcpServerHint': 'Відкрийте ArrowFlow Design як MCP-сервер для вашого кодинг-агента.',
  ...
  'preview.errorBody': 'Не вдалося отримати HTML прикладу. Переконайтеся, що ArrowFlow Design запущено, і повторіть спробу.',
  ...
  'pet.tabBuiltInHint': 'Кураторські супутники в комплекті з ArrowFlow Design — виберіть один та встановіть.',
  ...
  'pet.codexBundledTitle': 'Поставляється з ArrowFlow Design — завантаження не потрібне.',
