...
export const tr: Dict = {
  ...
  'settings.welcomeTitle': 'ArrowFlow Design kurulumu',
  ...
  'settings.agentInstall.pathHint':
    'Bir CLI\'yi npm veya Homebrew ile kurduysan ancak hâlâ kurulu değil olarak görünüyorsa, aracın bin dizininin ArrowFlow Design daemon\'unun devraldığı PATH içinde olduğundan emin ol (macOS\'te Terminal ve GUI uygulamalarının PATH\'i farklı olabilir). QUICKSTART.md içindeki "Local agent CLI and PATH" bölümüne bak.',
  'settings.agentInstall.stepOpenLinks': 'Tercih ettiğin ajan için Yükle veya Dokümanlar bağlantısını aç.',
  'settings.agentInstall.stepAuth':
    'ArrowFlow Design\'a dönmeden önce sağlayıcı CLI\'sinde kimlik doğrulaması yap (oturum aç veya API kimlik bilgileri ekle).',
  ...
  'settings.mcpServerHint': 'ArrowFlow Design\'ı kodlama ajanınız için MCP sunucusu olarak yayınlayın.',
  ...
  'preview.errorBody': 'Örnek HTML\'i alınamadı. ArrowFlow Design\'ın çalıştığından emin olup tekrar deneyin.',
  ...
  'pet.tabBuiltInHint': 'ArrowFlow Design ile gelen seçili dostlar — birini seç ve sahiplen.',
  ...
  'pet.codexBundledTitle': 'ArrowFlow Design ile birlikte gelir — indirme gerekmez.',
