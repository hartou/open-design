...
export const esES: Dict = {
  ...
  'settings.welcomeTitle': 'Configura ArrowFlow Design',
  ...
  'settings.agentInstall.pathHint':
    'Si instalaste una CLI con npm o Homebrew y sigue apareciendo como no instalada, asegúrate de que el directorio bin de la herramienta esté en el PATH que hereda el daemon de ArrowFlow Design (Terminal y apps GUI pueden diferir en macOS). Consulta QUICKSTART.md (sección "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Abre Instalar o Docs para el agente que prefieras.',
  'settings.agentInstall.stepAuth':
    'Autentícate con la CLI del proveedor (inicia sesión o añade credenciales API) antes de volver a ArrowFlow Design.',
  ...
  'settings.mcpServerHint': 'Expón ArrowFlow Design como servidor MCP para tu agente de código.',
  ...
  'preview.errorBody': 'No se pudo obtener el HTML del ejemplo. Asegúrate de que ArrowFlow Design esté en ejecución e inténtalo de nuevo.',
  ...
  'pet.tabBuiltInHint': 'Compañeros incluidos con ArrowFlow Design — elige uno y adóptalo.',
  ...
  'pet.codexBundledTitle': 'Viene con ArrowFlow Design — sin descarga.',
