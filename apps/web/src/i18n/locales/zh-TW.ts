...
export const zhTW: Dict = {
  ...
  'settings.welcomeTitle': '初始化 ArrowFlow Design',
  ...
  'settings.agentInstall.pathHint':
    '如果你透過 npm 或 Homebrew 安裝了 CLI，但仍顯示為未安裝，請確認該工具的 bin 目錄已加入 ArrowFlow Design daemon 繼承的 PATH（在 macOS 上，Terminal 與 GUI 應用的 PATH 可能不同）。請參閱 QUICKSTART.md（「Local agent CLI and PATH」章節）。',
  'settings.agentInstall.stepOpenLinks': '在目標代理卡片上開啟「安裝」或「文件」連結。',
  'settings.agentInstall.stepAuth':
    '返回 ArrowFlow Design 前，請先在對應 CLI 完成驗證（登入或新增 API 憑證）。',
  ...
  'settings.mcpServerHint': '將 ArrowFlow Design 作為 MCP 伺服器暴露給你的編碼代理。',
  ...
  'settings.privacy': '隱私',
  'settings.privacyHint': '與 ArrowFlow Design 團隊共享哪些資料',
  'settings.privacyConsentKicker': '協助我們改進 ArrowFlow Design',
  'settings.privacyConsentLead': 'ArrowFlow Design 可以將使用資料分享給我們的團隊以協助改進。包含:',
  ...
  'settings.mcpHint':
    '讓其他專案中的程式碼代理（Claude Code、Cursor、VS Code、Antigravity、Zed、Windsurf）讀取您的 ArrowFlow Design 專案。您可以直接將設計匯入應用程式，無需先匯出 zip。',
  'settings.mcpDaemonError':
    '無法連線到本地守護程序以解析安裝路徑（{error}）。請確認 ArrowFlow Design 正在執行，然後重新開啟此面板。',
  ...
  'settings.mcpCapabilityDefault':
    '預設使用您在 ArrowFlow Design 中開啟的專案與檔案，因此您可以說「在我的應用程式中建置這個」，無需重新說明是哪個設計。',
  'settings.mcpRunningNote':
    'ArrowFlow Design 必須正在執行，MCP 工具呼叫才能成功。如果您在開啟 ArrowFlow Design 之前就已啟動 coding agent，請重新啟動 agent，使其能夠連線到正在執行的守護行程。',
  ...
  'preview.errorBody': '範例 HTML 載入失敗。請確認 ArrowFlow Design 正在執行後重試。',
  'preview.retry': '重試',
  ...
  'pet.title': '寵物',
  'pet.tabBuiltIn': '內建',
  'pet.tabBuiltInHint': 'ArrowFlow Design 內建的精選寵物 — 一鍵領養。',
  ...
  'pet.codexBundled': '內建',
  'pet.codexBundledTitle': 'ArrowFlow Design 內建寵物，無需下載。',
  ...
  'settings.memoryStarterProjectDesc': 'ArrowFlow Design v0.5 — 聊天驅動的設計編輯器',
