...
export const id: Dict = {
  ...
  'settings.welcomeTitle': 'Siapkan ArrowFlow Design',
  ...
  'settings.agentInstall.pathHint':
    'Jika Anda memasang CLI dengan npm atau Homebrew tetapi masih tampil sebagai belum terpasang, pastikan direktori bin alat ada di PATH yang diwarisi daemon ArrowFlow Design (PATH Terminal dan aplikasi GUI bisa berbeda di macOS). Lihat QUICKSTART.md (bagian "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Buka Instal atau Dokumentasi untuk agen pilihan Anda.',
  'settings.agentInstall.stepAuth':
    'Lakukan autentikasi di CLI vendor (masuk atau tambahkan kredensial API) sebelum kembali ke ArrowFlow Design.',
  ...
  'settings.mcpServerHint': 'Ekspos ArrowFlow Design sebagai server MCP untuk agen koding Anda.',
  ...
  'preview.errorBody': 'Pengambilan HTML contoh gagal. Pastikan ArrowFlow Design berjalan, lalu coba lagi.',
  ...
  'pet.tabBuiltInHint': 'Pet pilihan yang disertakan dengan ArrowFlow Design - pilih satu lalu adopsi.',
  ...
  'pet.codexBundledTitle': 'Disertakan dengan ArrowFlow Design - tidak perlu diunduh.',
