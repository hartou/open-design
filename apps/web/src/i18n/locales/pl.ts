...
export const pl: Dict = {
  ...
  'settings.welcomeTitle': 'Skonfiguruj ArrowFlow Design',
  ...
  'settings.agentInstall.pathHint':
    'Jeśli zainstalowano CLI przez npm lub Homebrew, ale nadal widnieje jako niezainstalowana, upewnij się, że katalog bin narzędzia jest w PATH dziedziczonym przez daemon ArrowFlow Design (na macOS PATH w Terminalu i aplikacjach GUI może się różnić). Zobacz QUICKSTART.md (sekcja "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Otwórz Zainstaluj lub Dokumentacja dla wybranego agenta.',
  'settings.agentInstall.stepAuth':
    'Uwierzytelnij się w CLI dostawcy (zaloguj się lub dodaj dane API), zanim wrócisz do ArrowFlow Design.',
  ...
  'settings.mcpServerHint': 'Udostępnij ArrowFlow Design jako serwer MCP dla swojego agenta kodu.',
  ...
  'preview.errorBody': 'Nie udało się pobrać kodu HTML przykładu. Upewnij się, że ArrowFlow Design jest uruchomiony, i spróbuj ponownie.',
  ...
  'pet.tabBuiltInHint': 'Towarzysze dołączeni do ArrowFlow Design — wybierz jednego i adoptuj.',
  ...
  'pet.codexBundledTitle': 'Dostarczany z ArrowFlow Design — bez pobierania.',
