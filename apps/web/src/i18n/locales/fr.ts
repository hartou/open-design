...
export const fr: Dict = {
  ...
  'settings.welcomeTitle': 'Configurer ArrowFlow Design',
  ...
  'settings.agentInstall.pathHint':
    'Si vous avez installé une CLI avec npm ou Homebrew et qu\'elle apparaît toujours comme non installée, vérifiez que le dossier bin de l\'outil est dans le PATH hérité par le daemon ArrowFlow Design (Terminal et apps GUI peuvent différer sur macOS). Voir QUICKSTART.md (section "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Ouvrez Installer ou Docs pour l\'agent souhaité.',
  'settings.agentInstall.stepAuth':
    'Authentifiez-vous avec la CLI du fournisseur (connexion ou ajout des identifiants API) avant de revenir dans ArrowFlow Design.',
  ...
  'settings.mcpServerHint': 'Exposez ArrowFlow Design comme serveur MCP pour votre agent de code.',
  ...
  'preview.errorBody': 'Le chargement du HTML de l\'exemple a échoué. Vérifiez qu\'ArrowFlow Design est en cours d\'exécution et réessayez.',
  ...
  'pet.tabBuiltInHint': 'Compagnons fournis avec ArrowFlow Design — choisissez-en un et adoptez-le.',
  ...
  'pet.codexBundledTitle': 'Livré avec ArrowFlow Design — aucun téléchargement nécessaire.',
