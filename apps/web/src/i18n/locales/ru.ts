...
export const ru: Dict = {
  ...
  'settings.welcomeTitle': 'Настройте ArrowFlow Design',
  ...
  'settings.agentInstall.pathHint':
    'Если вы установили CLI через npm или Homebrew, но она всё ещё отмечена как не установленная, убедитесь, что bin-каталог инструмента есть в PATH, который наследует daemon ArrowFlow Design (в macOS PATH у Terminal и GUI-приложений может отличаться). См. QUICKSTART.md (раздел "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Откройте Установить или Документация для нужного агента.',
  'settings.agentInstall.stepAuth':
    'Пройдите аутентификацию в CLI поставщика (вход или добавление API-ключей), затем вернитесь в ArrowFlow Design.',
  ...
  'settings.mcpServerHint': 'Откройте ArrowFlow Design как MCP-сервер для вашего кодинг-агента.',
  ...
  'preview.errorBody': 'Не удалось получить HTML примера. Убедитесь, что ArrowFlow Design запущен, и повторите попытку.',
  ...
  'pet.tabBuiltInHint': 'Подобранные питомцы в комплекте ArrowFlow Design — выберите и забирайте.',
  ...
  'pet.codexBundledTitle': 'Поставляется с ArrowFlow Design — загрузка не нужна.',
