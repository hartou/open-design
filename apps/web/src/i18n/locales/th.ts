...
export const th: Dict = {
  ...
  'settings.welcomeTitle': 'ตั้งค่า ArrowFlow Design',
  ...
  'settings.agentInstall.pathHint':
    'หากคุณติดตั้ง CLI ด้วย npm หรือ Homebrew แล้วแต่ยังแสดงว่าไม่ได้ติดตั้ง โปรดตรวจสอบว่าโฟลเดอร์ bin ของเครื่องมือนั้นอยู่ใน PATH ที่ ArrowFlow Design daemon ใช้งาน (บน macOS ค่า PATH ของ Terminal และแอป GUI อาจต่างกัน) ดู QUICKSTART.md (ส่วน "Local agent CLI and PATH")',
  'settings.agentInstall.stepOpenLinks': 'เปิดลิงก์ติดตั้งหรือเอกสารสำหรับเอเจนต์ที่ต้องการ',
  'settings.agentInstall.stepAuth':
    'ยืนยันตัวตนกับ CLI ของผู้ให้บริการ (ลงชื่อเข้าใช้หรือเพิ่มข้อมูลรับรอง API) ก่อนกลับไปที่ ArrowFlow Design',
  ...
  'settings.mcpServerHint': 'เปิดให้ ArrowFlow Design เป็นเซิร์ฟเวอร์ MCP สำหรับเอเจนต์โค้ด',
  ...
  'settings.privacyHint': 'ข้อมูลที่แชร์กับทีม ArrowFlow Design',
  'settings.privacyConsentKicker': 'ช่วยเราพัฒนา ArrowFlow Design',
  'settings.privacyConsentLead': 'ArrowFlow Design สามารถแชร์ข้อมูลการใช้งานกับทีมของเราเพื่อช่วยพัฒนา ซึ่งรวมถึง:',
  ...
  'pet.tabBuiltInHint': 'จัดกลุ่มให้พร้อมใช้กับชุดระบบจาก ArrowFlow Design แล้ว — เอาได้เลย',
  ...
  'pet.codexBundledTitle': 'เตรียมมาให้กับ ArrowFlow Design แล้ว — ไม่ต้องดาวน์โหลดใหม่',
