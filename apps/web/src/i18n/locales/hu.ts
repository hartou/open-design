...
export const hu: Dict = {
  ...
  'settings.welcomeTitle': 'ArrowFlow Design beállítása',
  ...
  'settings.agentInstall.pathHint':
    'Ha npm-mel vagy Homebrew-val telepítettél egy CLI-t, de továbbra is nincs telepítve állapotban látszik, ellenőrizd, hogy az eszköz bin könyvtára benne van-e abban a PATH-ban, amit az ArrowFlow Design daemon örököl (macOS-en a Terminal és a GUI appok PATH-ja eltérhet). Lásd a QUICKSTART.md "Local agent CLI and PATH" szakaszát.',
  'settings.agentInstall.stepOpenLinks': 'Nyisd meg a Telepítés vagy Dokumentáció hivatkozást a kívánt ügynöknél.',
  'settings.agentInstall.stepAuth':
    'Hitelesíts a szolgáltató CLI-jében (bejelentkezés vagy API hitelesítő adatok megadása), mielőtt visszatérsz az ArrowFlow Designhoz.',
  ...
  'settings.mcpServerHint': 'Tedd elérhetővé az ArrowFlow Designt MCP-szerverként a kódügynököd számára.',
  ...
  'preview.errorBody': 'A példa HTML-jének letöltése meghiúsult. Győződj meg róla, hogy az ArrowFlow Design fut, majd próbáld újra.',
  'preview.retry': 'Újra',
  ...
  'pet.tabBuiltInHint': 'Az ArrowFlow Designnal csomagolt társak — válassz egyet és fogadd örökbe.',
  ...
  'pet.codexBundledTitle': 'Az ArrowFlow Designgal érkezik — letöltés nem szükséges.',
