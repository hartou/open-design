...
export const ar: Dict = {
  ...
  'settings.welcomeTitle': 'إعداد ArrowFlow Design',
  ...
  'settings.agentInstall.pathHint':
    'إذا ثبّتّ CLI باستخدام npm أو Homebrew وما زال يظهر كغير مثبت، فتأكد من أن مجلد bin للأداة موجود في PATH الذي يرثه daemon الخاص بـ ArrowFlow Design (قد يختلف PATH بين Terminal وتطبيقات GUI على macOS). راجع QUICKSTART.md (قسم "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'افتح رابط التثبيت أو الوثائق للوكيل الذي تفضله.',
  'settings.agentInstall.stepAuth':
    'أكمِل المصادقة في CLI الخاص بالمزوّد (تسجيل الدخول أو إضافة بيانات اعتماد API) قبل العودة إلى ArrowFlow Design.',
  ...
  'settings.mcpServerHint': 'كشف ArrowFlow Design كخادم MCP لوكيل البرمجة الخاص بك.',
  ...
  'preview.errorBody': 'فشل جلب HTML الخاص بالمثال. تأكد من تشغيل ArrowFlow Design ثم أعد المحاولة.',
  ...
  'pet.tabBuiltIn': 'مدمج',
  'pet.tabBuiltInHint': 'رفقاء منتقون مدمجون مع ArrowFlow Design - اختر واحداً وتبنَّه.',
  ...
  'pet.codexBundledTitle': 'يأتي مع ArrowFlow Design - لا حاجة للتحميل.',
