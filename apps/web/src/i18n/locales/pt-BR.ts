...
export const ptBR: Dict = {
  ...
  'settings.welcomeTitle': 'Configure o ArrowFlow Design',
  ...
  'settings.agentInstall.pathHint':
    'Se você instalou uma CLI com npm ou Homebrew e ela ainda aparece como não instalada, garanta que o diretório bin da ferramenta esteja no PATH herdado pelo daemon do ArrowFlow Design (Terminal e apps GUI podem diferir no macOS). Veja QUICKSTART.md (seção "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Abra Instalar ou Docs para o agente desejado.',
  'settings.agentInstall.stepAuth':
    'Autentique-se na CLI do fornecedor (faça login ou adicione credenciais de API) antes de voltar ao ArrowFlow Design.',
  ...
  'settings.mcpServerHint': 'Exponha o ArrowFlow Design como servidor MCP para o seu agente de código.',
  ...
  'preview.errorBody': 'A obtenção do HTML do exemplo falhou. Verifique se o ArrowFlow Design está em execução e tente novamente.',
  ...
  'pet.tabBuiltInHint': 'Companheiros incluídos no ArrowFlow Design — escolha um e adote.',
  ...
  'pet.codexBundledTitle': 'Já vem com o ArrowFlow Design — sem download.',
