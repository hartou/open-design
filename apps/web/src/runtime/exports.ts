...
export function buildDesignManifestContent(opts: {
  ...
  const title = opts.title || 'ArrowFlow Design artifact';
...
- Keep generated product UI free of ArrowFlow Design chrome, preview labels, or design-process annotations.
...
- Do not keep prototype-only annotations, frame labels, or ArrowFlow Design chrome in the production UI.
