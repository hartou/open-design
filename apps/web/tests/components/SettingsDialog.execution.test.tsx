...
describe('SettingsDialog MCP server interactions', () => {
  const installInfo = {
    command: '/Applications/ArrowFlow Design.app/Contents/Resources/open-design/bin/node',
    args: [
      '/Applications/ArrowFlow Design.app/Contents/Resources/app/node_modules/@open-design/daemon/dist/cli.js',
      'mcp',
      '--daemon-url',
  ...
  it('renders the default Claude Code install snippet after fetching daemon install info', async () => {
    ...
    expect(screen.getByText(/ArrowFlow Design must be running for MCP tool calls to succeed/i)).toBeTruthy();
  });
